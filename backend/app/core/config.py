...
class Settings:
    ...
    AI_MODEL: str = os.environ.get("AI_MODEL", AI_MODEL_BASIC)
    AI_COMPILE_TIMEOUT_SECONDS: int = max(1, int(os.environ.get("AI_COMPILE_TIMEOUT_SECONDS", 8)))
    AI_ANSWER_TIMEOUT_SECONDS: int = max(1, int(os.environ.get("AI_ANSWER_TIMEOUT_SECONDS", 9)))
    AI_INTERACTIVE_DEADLINE_SECONDS: int = min(25, max(5, int(os.environ.get("AI_INTERACTIVE_DEADLINE_SECONDS", 25))))
