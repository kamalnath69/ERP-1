...
class Settings:
    ...
    AI_MODEL_PLANNER: str = os.environ.get("AI_MODEL_PLANNER", AI_MODEL_BASIC)
    AI_MODEL_SYNTHESIS: str = os.environ.get("AI_MODEL_SYNTHESIS", AI_MODEL_BASIC)
    AI_MODEL_REPAIR: str = os.environ.get("AI_MODEL_REPAIR", AI_MODEL_SYNTHESIS)
    ...
    AI_EXECUTION_V3_DEFAULT: bool = _bool_env("AI_EXECUTION_V3_DEFAULT", True)
    AI_PLANNER_TIMEOUT_SECONDS: int = max(1, int(os.environ.get("AI_PLANNER_TIMEOUT_SECONDS", 5)))
    AI_TOOL_TIMEOUT_SECONDS: int = max(1, int(os.environ.get("AI_TOOL_TIMEOUT_SECONDS", 3)))
    AI_SYNTHESIS_TIMEOUT_SECONDS: int = max(1, int(os.environ.get("AI_SYNTHESIS_TIMEOUT_SECONDS", 10)))
    AI_TOTAL_TIMEOUT_SECONDS: int = max(3, int(os.environ.get("AI_TOTAL_TIMEOUT_SECONDS", 15)))
