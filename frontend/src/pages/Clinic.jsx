    ...
    {record && <div className="space-y-6">
      ...
      <form noValidate onSubmit={save} className="space-y-4">
        ...
        {editable && <div className="flex flex-wrap gap-2">
          <Button type="submit" variant="outline" loading={updateState.isLoading || draftApi.formState.isSubmitting} loadingText="Saving draft..." disabled={!draftApi.formState.isValid || (busy && !updateState.isLoading)}>Save draft</Button>
      ...
      {editable && <Surface className="p-5">
        ...
        <form noValidate onSubmit={addDiagnosis} className="mt-4 space-y-2">
          <div className="flex gap-2">
            ...
            <Button type="submit" variant="outline" loading={diagnosisState.isLoading || diagnosisApi.formState.isSubmitting} loadingText="Adding..." disabled={!diagnosisApi.formState.isValid || (busy && !diagnosisState.isLoading)}>Add</Button>
          </div>
      ...
      {editable && <Surface className="p-5">
        ...
        <form noValidate onSubmit={addPrescription} className="mt-4 space-y-4">
          ...
          <Button type="submit" variant="outline" loading={prescriptionState.isLoading || prescriptionApi.formState.isSubmitting} loadingText="Creating draft..." disabled={!prescriptionApi.formState.isValid || (busy && !prescriptionState.isLoading)}>Create prescription draft</Button>
        </form>
      </Surface>}
    </div>}
  </DrawerForm>;
